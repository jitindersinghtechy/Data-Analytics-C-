...
if (!isScriptAlreadyIncluded("http://analyticsv1.azurewebsites.net/Content/owl.carousel.css")) {
    document.write('<link href="http://analyticsv1.azurewebsites.net/Content/owl.carousel.css" rel="stylesheet" />');
}
...
if (!isScriptAlreadyIncluded("http://analyticsv1.azurewebsites.net/Scripts/owl.carousel.min.js")) {
    document.write('<script src="http://analyticsv1.azurewebsites.net/Scripts/owl.carousel.min.js"></script>');
}
...
if (!isScriptAlreadyIncluded("http://analyticsv1.azurewebsites.net/Scripts/angularjs-dropdown-multiselect.js")) {
    ...
    document.write('<script src="http://analyticsv1.azurewebsites.net/App/Widgets/TopPerformersAndPinnedUsers/app.js"></script>');
document.write('<script src="http://analyticsv1.azurewebsites.net/App/Widgets/TopPerformersAndPinnedUsers/topPerformersAndPinnedUsersService.js"></script>');
document.write('<script src="http://analyticsv1.azurewebsites.net/App/Widgets/TopPerformersAndPinnedUsers/topPerformersAndPinnedUsersComponent.js"></script>');
