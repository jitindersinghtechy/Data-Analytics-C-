...
appNavMap.component("navMap", {
    templateUrl: serviceBase + "api/Dashboard/NavMapView",
    bindings: { name: '@' },
    ...
    controller: ['$scope', 'navMapService', '$location', '$filter', '$compile', '$timeout', function ($scope, navMapService, $location, $filter, $compile, $timeout) {
        var vm = this;
        ...
        vm.mainChart = function () {
            ...
            navMapService.getNavMapData(vm.SelectedTimelineId).then(function (response) {
                ...
                if (vm.Countries.length == 0) {
                    ...
                    $("#NavCompareDataHead1").append('<img src="http://analyticsv1.azurewebsites.net/images/icon/currency-value.png" alt=""><h3>Equity Graph</h3>');
                    vm.drillDownlevel = 0;
